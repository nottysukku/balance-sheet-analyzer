/**
 * API response types, mirroring `server/src/domain/types.ts`.
 *
 * Kept as a copy rather than a shared package so the two workspaces install
 * and build independently; the pipeline test suite is what guards the shape.
 */
